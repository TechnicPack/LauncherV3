...
public class SimpleScrollbarUI extends BasicScrollBarUI {
  ...
  protected void uninstallComponents() {
    // Do nothing.
    // The buttons never get created or added, so this is here to prevent a NullPointerException,
    // which happens
    // when BasicScrollBarUI.uninstallComponents() calls scrollbar.remove(x) with x being a null
    // button
  }
