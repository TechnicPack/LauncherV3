...
public class StatBox extends JButton {
  ...
  public void setForeground(Color color) {
    ...
    if (fieldLabel != null) fieldLabel.setForeground(color);

    if (valueLabel != null) valueLabel.setForeground(color);
  }
  ...
  protected void paintComponent(Graphics g) {
    ...
    Dimension arcs =
        new Dimension(5, 5); // Border corners arcs {width,height}, change this to whatever you want
    int width = getWidth();
    ...
    graphics.fillRoundRect(
        0, 0, width - 1, height - 1, arcs.width, arcs.height); // paint background
  }
  ...
  private String buildValueStr(Integer value) {
    ...
    } else return NumberFormat.getInstance().format(value);
  }
