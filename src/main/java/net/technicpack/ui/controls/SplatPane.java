...
public class SplatPane extends JComponent {
  ...
  public void paintComponent(Graphics g) {
    ...
    if (this.alignment == JLabel.NORTH || this.alignment == JLabel.SOUTH) x = x + (widthDiff / 2);
    if (this.alignment == JLabel.EAST || this.alignment == JLabel.WEST) y = y + (heightDiff / 2);
    if (this.alignment == JLabel.NORTH_EAST
        || this.alignment == JLabel.EAST
        || this.alignment == JLabel.SOUTH_EAST) x += widthDiff;
    if (this.alignment == JLabel.SOUTH_EAST
        || this.alignment == JLabel.SOUTH
        || this.alignment == JLabel.SOUTH_WEST) y += heightDiff;
