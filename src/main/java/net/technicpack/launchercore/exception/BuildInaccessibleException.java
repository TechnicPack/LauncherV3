...
public class BuildInaccessibleException extends IOException {
  ...
  public String getMessage() {
    if (this.cause != null) {
      ...
      return "An error was raised while attempting to read pack info for modpack "
          + packDisplayName
          + ", build "
          + build
          + ": "
      ...
      return "The pack host returned unrecognizable garbage while attempting to read pack info for modpack "
          + packDisplayName
          + ", build "
          + build
          + ".";
