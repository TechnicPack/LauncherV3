...
public class ProcessMonitorThread extends Thread {
  ...
  public void run() {
    ...
    try (InputStreamReader reader =
            new InputStreamReader(this.process.getProcess().getInputStream());
      ...
      this.logger.log(
          Level.SEVERE,
          "Error reading process output - process will continue running but output will not be logged",
          e);
    }
    ...
    try {
      ...
      this.logger.info(
          String.format("Process exited with code %d", process.getProcess().exitValue()));
