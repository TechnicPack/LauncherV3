...
public class FileBasedJavaRuntimeAdapter
    implements JsonSerializer<FileBasedJavaRuntime>, JsonDeserializer<FileBasedJavaRuntime> {

  @Override
  public JsonElement serialize(
      FileBasedJavaRuntime src, Type typeOfSrc, JsonSerializationContext context) {
  ...
  @Override
  public FileBasedJavaRuntime deserialize(
