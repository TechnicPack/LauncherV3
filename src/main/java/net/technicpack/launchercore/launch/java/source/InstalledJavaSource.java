...
/**
 * This IVersionSource is used to collect the known-installed versions of java. The code is
 * OS-specific, so the logic here is mainly for breaking out to the OS-specific versions
 */
