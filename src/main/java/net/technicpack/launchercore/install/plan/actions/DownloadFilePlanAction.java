...
public class DownloadFilePlanAction<TContext> implements PlanNodeAction<TContext> {
    ...
    public DownloadFilePlanAction(String url, File destination, IFileVerifier verifier, String taskDescription) {
        this.url = url;
    ...
    @Override
    public void execute(TContext context, NodeProgressReporter reporter) throws IOException, InterruptedException {
        ...
        Utils.downloadFile(url, tempDestination.getName(), tempDestination.getAbsolutePath(), null,
                           downloadFileVerifier, new DownloadProgressAdapter(reporter, taskDescription,
                                   useTaskDescriptionForProgressLabel));
    ...
    static String buildProgressLabel(String fileName, String taskDescription, boolean useTaskDescriptionForProgressLabel) {
    ...
    public DownloadFilePlanAction<TContext> withDecompressor(String decompressor) throws DownloadException {
    ...
    private static class DownloadProgressAdapter implements DownloadListener {
        ...
        private DownloadProgressAdapter(NodeProgressReporter reporter, String taskDescription,
        ...
        public void stateChanged(String fileName, float progress) {
            String progressLabel = buildProgressLabel(fileName, taskDescription, useTaskDescriptionForProgressLabel);
            if (progress > 0.0f) {
