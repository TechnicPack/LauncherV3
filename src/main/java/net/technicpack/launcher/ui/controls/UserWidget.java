...
public class UserWidget extends JPanel {
    ...
    private void initComponents() {
        ...
        staticText.setFont(resources.getFont("Raleway-ExtraLight.ttf", 15));
        this.add(staticText);

        JLabel userName = new JLabel("sct");
        userName.setForeground(LauncherFrame.COLOR_WHITE_TEXT);
        userName.setFont(resources.getFont("Raleway-ExtraLight.ttf", 15, Font.BOLD));
        this.add(userName);

        JLabel staticText2 = new JLabel(" | ");
        staticText2.setForeground(LauncherFrame.COLOR_WHITE_TEXT);
        staticText2.setFont(resources.getFont("Raleway-ExtraLight.ttf", 15));
        this.add(staticText2);

        JLabel logout = new JLabel("Logout");
        logout.setForeground(LauncherFrame.COLOR_WHITE_TEXT);
        logout.setFont(resources.getFont("Raleway-ExtraLight.ttf", 15));
        this.add(logout);
    }
}
