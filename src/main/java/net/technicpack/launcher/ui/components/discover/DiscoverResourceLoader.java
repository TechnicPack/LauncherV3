...
public class DiscoverResourceLoader extends ImageResourceLoader {
  public static final RepaintListener NO_OP_REPAINT_LISTENER =
      doLayout -> XRLog.general(Level.FINE, "No-op repaint requested");
  ...
  public DiscoverResourceLoader(int cacheSize) {
    ...
    this._useBackgroundImageLoading =
        Configuration.isTrue("xr.image.background.loading.enable", false);
    ...
    // note we do *not* override removeEldestEntry() here--users of this class must call
    // shrinkImageCache().
