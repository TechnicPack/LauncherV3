...
public interface ISolderApi {
  ISolderPackApi getSolderPack(String solderRoot, String modpackSlug, String mirrorUrl)
  ...
  Collection<SolderPackInfo> internalGetPublicSolderPacks(String solderRoot, ISolderApi packFactory)
      throws RestfulAPIException;
}
