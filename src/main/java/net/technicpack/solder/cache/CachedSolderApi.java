...
public class CachedSolderApi implements ISolderApi {
  ...
  private static class CacheTuple {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof CacheTuple)) return false;

      if (!root.equals(((CacheTuple) obj).root)) return false;
      if (!slug.equals(((CacheTuple) obj).slug)) return false;
      if (!url.equals(((CacheTuple) obj).url)) return false;
      return true;
    }
