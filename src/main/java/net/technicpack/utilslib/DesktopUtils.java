/**
 * This file is part of Technic Launcher Core. Copyright ©2015 Syndicate, LLC
 *
 * <p>Technic Launcher Core is free software: you can redistribute it and/or modify it under the
 * terms of the GNU Lesser General Public License as published by the Free Software Foundation,
 * either version 3 of the License, or (at your option) any later version.
 *
 * <p>Technic Launcher Core is distributed in the hope that it will be useful, but WITHOUT ANY
 * WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR
 * PURPOSE. See the GNU General Public License for more details.
 *
 * <p>You should have received a copy of the GNU General Public License, as well as a copy of the
 * GNU Lesser General Public License, along with Technic Launcher Core. If not, see
...
public class DesktopUtils {
  ...
  public static void browseUrl(String url) {
    new SwingWorker<Void, Void>() {
      ...
      protected Void doInBackground() {
        try {
          if (url.startsWith("mailto:")) Desktop.getDesktop().mail(new URI(url));
          else {
            ...
            else SwingUtilities.invokeLater(() -> showBrowseUrlDialog(url));
          }
        } catch (IOException e) {
  ...
  public static void open(final File file) {
    new SwingWorker<Void, Void>() {
      ...
      protected Void doInBackground() {
        open(
            file,
            DesktopUtils::canOpenWithDesktop,
            DesktopUtils::openWithDesktop,
            DesktopUtils::launchProcess,
  ...
  static void open(
    ...
    try {
      ...
      Utils.getLogger()
          .log(
              Level.WARNING,
              String.format("Desktop open failed for %s", file.getAbsolutePath()),
              e);
    }
    ...
    try {
      ...
      Utils.getLogger()
          .log(Level.SEVERE, String.format("Unable to open %s", file.getAbsolutePath()), e);
    }
  }
  ...
  private static void openWithFallback(
      File file, Consumer<String[]> processLauncher, OperatingSystem operatingSystem) {
    ...
    switch (operatingSystem) {
      ...
      default:
        throw new IllegalStateException(
            String.format(
                "No folder-opening fallback available for operating system %s", operatingSystem));
    }
  }
}
